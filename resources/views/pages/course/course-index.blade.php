		...
		<div class="course-warp">
			...
			<div class="row course-items-area">
				...
				<div class="mix col-lg-3 col-md-4 col-sm-6 web">
					<div class="course-item">
						<div class="course-thumb set-bg" data-setbg="{{asset('frontend-assets/assets/img/courses/2.jpg')}}">
						</div>
						<div class="course-info">
							<div class="course-text">
								<a href="course-list.html">
				...
				<div class="mix col-lg-3 col-md-4 col-sm-6 photo">
					<div class="course-item">
						<div class="course-thumb set-bg" data-setbg="{{asset('frontend-assets/assets/img/courses/3.jpg')}}">
						</div>
						<div class="course-info">
							<div class="course-text">
								<a href="course-list.html">
							...
							<div class="course-author">
								<div class="ca-pic set-bg" data-setbg="{{asset('frontend-assets/assets/img/authors/3.jpg')}}"></div>
								<p>William Parker, <span>Developer</span></p>
							</div>
						</div>
					</div>
				...
				<div class="mix col-lg-3 col-md-4 col-sm-6 web">
					<div class="course-item">
						<div class="course-thumb set-bg" data-setbg="{{asset('frontend-assets/assets/img/courses/4.jpg')}}">
						</div>
						<div class="course-info">
							<div class="course-text">
								<a href="course-list.html">
							...
							<div class="course-author">
								<div class="ca-pic set-bg" data-setbg="{{asset('frontend-assets/assets/img/authors/4.jpg')}}"></div>
								<p>William Parker, <span>Developer</span></p>
							</div>
						</div>
					</div>
				...
				<div class="mix col-lg-3 col-md-4 col-sm-6 web">
					<div class="course-item">
						<div class="course-thumb set-bg" data-setbg="{{asset('frontend-assets/assets/img/courses/5.jpg')}}"> 
						</div>
						<div class="course-info">
							<div class="course-text">
								<a href="course-list.html">
							...
							<div class="course-author">
								<div class="ca-pic set-bg" data-setbg="{{asset('frontend-assets/assets/img/authors/5.jpg')}}"></div>
								<p>William Parker, <span>Developer</span></p>
							</div>
						</div>
					</div>
				...
				<div class="mix col-lg-3 col-md-4 col-sm-6 web">
					<div class="course-item">
						<div class="course-thumb set-bg" data-setbg="{{asset('frontend-assets/assets/img/courses/6.jpg')}}">
						</div>
						<div class="course-info">
							<div class="course-text">
								<a href="course-list.html">
							...
							<div class="course-author">
								<div class="ca-pic set-bg" data-setbg="{{asset('frontend-assets/assets/img/authors/6.jpg')}}"></div>
								<p>William Parker, <span>Developer</span></p>
							</div>
						</div>
					</div>
				...
				<div class="mix col-lg-3 col-md-4 col-sm-6 finance">
					<div class="course-item">
						<div class="course-thumb set-bg" data-setbg="{{asset('frontend-assets/assets/img/courses/7.jpg')}}">
						</div>
						<div class="course-info">
							<div class="course-text">
								<a href="course-list.html">
							...
							<div class="course-author">
								<div class="ca-pic set-bg" data-setbg="{{asset('frontend-assets/assets/img/authors/7.jpg')}}"></div>
								<p>William Parker, <span>Developer</span></p>
							</div>
						</div>
					</div>
				...
				<div class="mix col-lg-3 col-md-4 col-sm-6 design">
					<div class="course-item">
						<div class="course-thumb set-bg" data-setbg="{{asset('frontend-assets/assets/img/courses/8.jpg')}}">
						</div>
						<div class="course-info">
							<div class="course-text">
								<a href="course-list.html">
							...
							<div class="course-author">
								<div class="ca-pic set-bg" data-setbg="{{asset('frontend-assets/assets/img/authors/8.jpg')}}"></div>
								<p>William Parker, <span>Developer</span></p>
							</div>
						</div>
					</div>
